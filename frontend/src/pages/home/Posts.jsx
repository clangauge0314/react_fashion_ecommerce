...
const Posts = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      <div className="relative bg-white h-[300px] flex items-center justify-center">
        <div className="absolute inset-0 bg-white"></div>
        <div className="relative text-center">
          <h1 className="text-black text-5xl font-bold mb-4">お知らせ</h1>
          <p className="text-black text-xl">重要なお知らせと最新情報をご確認ください</p>
        </div>
      </div>
